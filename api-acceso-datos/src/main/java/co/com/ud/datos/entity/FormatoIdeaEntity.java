...
@NamedQueries({
        ...
        @NamedQuery(name="FormatoIdeaEntity.getFormatosByIdeaAndTipoFormato", query = "from FormatoIdeaEntity formato where formato.idea.id = :idIdea and formato.formato = :tipoFormato order by formato.id asc ")
