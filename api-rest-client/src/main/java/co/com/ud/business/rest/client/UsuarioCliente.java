...
@FeignClient(name = "api-acceso-datos"
        , contextId = "${endpoint.ms-acceso-datos.usuarios.name}"
        , path = "${endpoint.ms-acceso-datos.base}${endpoint.ms-acceso-datos.usuarios.version}${endpoint.ms-acceso-datos.usuarios.url}"
